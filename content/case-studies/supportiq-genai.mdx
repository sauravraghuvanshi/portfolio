...
We are currently testing and training the model with synthetic data. The next step is to **pilot this with a subset of engineers using real CSS data** to validate the efficiency gains in production conditions and iterate on the prioritization algorithms based on real-world feedback.
